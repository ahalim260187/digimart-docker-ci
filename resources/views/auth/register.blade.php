...
@section('content')
    ...
    <section class="breadcrumb border-bottom p-0 d-block section-bg position-relative z-index-1"
        style="background: url({{ asset('assets/frontend/assets/images/thumbs/breadcrumb_bg.jpg') }});">
        <div class="breadcrumb-two">
            <img src={{ asset('assets/frontend/assets/images/gradients/breadcrumb-gradient-bg.png') }} alt=""
                class="bg--gradient">
            ...
            <div class="row">
                <div class="col-xxl-5 col-xl-6 col-md-9 col-lg-7 m-auto">
                    <div class="wsus__login_area">
                        ...
                        <p class="create_account mt-2">have an account ? <a href="{{ route('login') }}">Sign In</a></p>
                    </div>
                </div>
            </div>
        </div>
