...
<head>
    ...
    <!-- line awesome -->
    <link rel="stylesheet" href={{ asset('assets/frontend/assets/css/line-awesome.min.css') }}>
    <!-- Tabler Icons CSS -->
...
<body>
    ...
    <!-- Bootstrap Bundle Js -->
    <script src={{ asset('assets/frontend/assets/js/boostrap.bundle.min.js') }}></script>
    <!-- CountDown -->
    ...
    <!-- apex chart -->
    <script src={{ asset('assets/frontend/assets/js/apexchart.js') }}></script>
    <!-- marquee -->
    <script src={{ asset('assets/frontend/assets/js/marquee.min.js') }}></script>
    <!-- infinite slide  -->
    <script src={{ asset('assets/frontend/assets/js/infiniteslidev2.js') }}></script>
    <!-- select 2  -->`
