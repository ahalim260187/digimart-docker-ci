    ...
    <section class="hero section-bg z-index-1">
        <img src={{ asset('assets/frontend/assets/images/gradients/banner-gradient.png') }} alt=""
            ...
            <div class="row gy-sm-5 gy-4">
                <div class="col-xl-6 col-lg-9 col-12">
                    <div class="hero-inner position-relative">
                        <div>
                            <h1 class="hero-inner__title">--Testing Ubah code update lsg di ec2 server -- 2 million+ well chosen digital</h1>
                            ...
                            <div class="position-relative">
                                <div class="search-box">
                                    ...
                                    <button type="submit" class="btn btn-main btn-icon icon border-0"><img
                                            src={{ asset('assets/frontend/assets/images/icons/search.svg') }}
                                            alt=""></button>
                                </div>
                                ...
                                <ul class="auto-suggestion-list">
                                    ...
                                    <li>
                                        <a href="#" class="auto-suggestion-list__item w-100 text-body">Ecommerce
                                            in
                                            HTML</a>
                                    </li>
                                    <li>
                ...
                <div class="col-xl-3 col-12 col-md-6 col-lg-4">
                    <div class="hero-thumb">
                        <ul class="direction_right">
                            <li><a href="#"><img
                                        src={{ asset('assets/frontend/assets/images/thumbs/product-img1.png') }}
                                        alt="" /></a>
                            </li>
                            <li><a href="#"><img
                                        src={{ asset('assets/frontend/assets/images/thumbs/product-img2.png') }}
                                        alt="" /></a>
                            </li>
                            <li><a href="#"><img
                                        src={{ asset('assets/frontend/assets/images/thumbs/product-img3.png') }}
                                        alt="" /></a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-xl-3 col-12 col-md-6 col-lg-4 pt-5 sm_margin">
                    <div class="hero-thumb">
                        <ul class="direction_left">
                            <li><a href="#"><img
                                        src={{ asset('assets/frontend/assets/images/thumbs/product-img4.png') }}
                                        alt="" /></a>
                            </li>
                            <li><a href="#"><img
                                        src={{ asset('assets/frontend/assets/images/thumbs/product-img5.png') }}
                                        alt="" /></a>
                            </li>
                            <li><a href="#"><img
                                        src={{ asset('assets/frontend/assets/images/thumbs/product-img6.png') }}
                                        alt="" /></a>
                            </li>
                        </ul>
                    </div>
